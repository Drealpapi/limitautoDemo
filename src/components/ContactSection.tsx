...
import { Phone, Mail, Clock, MapPin, CheckCircle, ArrowRight, Zap, Calendar, MessageSquare, AlertCircle } from 'lucide-react';
...
const URGENCY = [
  { val: 'emergency', label: 'Emergency — Right Now', Icon: AlertCircle },
  { val: 'today',     label: 'Today if Possible',    Icon: Zap         },
  { val: 'scheduled', label: 'Schedule for Later',   Icon: Calendar    },
  { val: 'quote',     label: 'Just a Quote',         Icon: MessageSquare },
];
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
        ...
        <div style={{ marginBottom: 52 }}>
          <h2 style={{
            ...
            color: '#1E2D45', lineHeight: 1.08, letterSpacing: '-0.7px', marginBottom: 10,
          }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'start' }} className="contact-grid">
          ...
          <div>
            ...
            <a href={PHONE_HREF} style={{
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = '0 14px 36px rgba(30,45,69,0.36), inset 0 1px 0 rgba(255,255,255,0.08)';
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLElement).style.transform = 'translateY(0)';
                (e.currentTarget as HTMLElement).style.boxShadow = '0 8px 28px rgba(30,45,69,0.28), inset 0 1px 0 rgba(255,255,255,0.08)';
              }}
            ...
            >
              ...
              <span style={{
                ...
                fontSize: 10, fontWeight: 700, color: '#fff', letterSpacing: '0.1em', flexShrink: 0,
              }}>EMERGENCY</span>
            </a>
            ...
            {[
              ...
              <div key={label} style={{
                ...
                padding: '15px 0', borderBottom: '1px solid #F0F3FA',
              }}>
                <div style={{
            ...
            <div style={{ marginTop: 26, background: '#EBF1FA', borderRadius: 10, padding: '18px 20px', border: '1px solid #D1DCF0' }}>
              ...
              {[
                ...
                <div key={item} style={{ display: 'flex', alignItems: 'flex-start', gap: 9, marginBottom: 9 }}>
                  <CheckCircle size={14} style={{ color: '#4A6FA5', flexShrink: 0, marginTop: 2 }} />
          ...
          {/* RIGHT: form */}
          <div style={{
            background: '#F6F8FC', borderRadius: 14, padding: '36px',
            border: '1px solid #E8EDF6',
            boxShadow: '0 4px 20px rgba(30,45,69,0.05)',
          }}>
            {state === 'success' ? (
              <div style={{ textAlign: 'center', padding: '52px 0' }}>
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  margin: '0 auto 20px',
                  boxShadow: '0 4px 16px rgba(74,111,165,0.2)',
                }}>
                  <CheckCircle size={28} color="#4A6FA5" />
                </div>
                ...
                <a href={PHONE_HREF} className="btn btn-navy"
                  style={{ textDecoration: 'none', padding: '12px 26px', fontSize: 14, display: 'inline-flex' }}>
                  <Phone size={14} /> {PHONE}
                </a>
              </div>
            ) : (
              <form onSubmit={onSubmit} noValidate aria-label="Service request">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9, marginBottom: 22 }}>
                  {URGENCY.map(o => {
                    const { Icon } = o;
                    const active = urgency === o.val;
                    return (
                      <button key={o.val} type="button" onClick={() => setUrgency(o.val)} style={{
                        textAlign: 'left', fontSize: 12.5, fontWeight: 500,
                        padding: '10px 12px', borderRadius: 8,
                        border: active ? '2px solid #4A6FA5' : '1.5px solid #DDE4F0',
                        background: active ? '#EBF1FA' : '#fff',
                        color: active ? '#1E2D45' : '#6B7A99',
                        cursor: 'pointer', transition: 'all 0.14s ease',
                        display: 'flex', alignItems: 'center', gap: 7,
                        boxShadow: active ? '0 2px 8px rgba(74,111,165,0.12)' : 'none',
                      }}
                        onMouseEnter={e => { if (!active) { (e.currentTarget as HTMLElement).style.borderColor = '#B0C4DE'; (e.currentTarget as HTMLElement).style.background = '#F0F4FB'; } }}
                        onMouseLeave={e => { if (!active) { (e.currentTarget as HTMLElement).style.borderColor = '#DDE4F0'; (e.currentTarget as HTMLElement).style.background = '#fff'; } }}
                      >
                        <Icon size={13} style={{ flexShrink: 0, color: active ? '#4A6FA5' : '#9CAABA' }} />
                        {o.label}
                      </button>
                    );
                  })}
